...
<# Replaced by Michael Pietroforte
 Run-Convert-Reg2Xml -regPath "C:\support\ReceiverCSTRegUpx64.reg" -xmlPath C:\support\Citrix.xml #>
 Run-Convert-Reg2Xml -regPath $regPath -xmlPath $xmlPath